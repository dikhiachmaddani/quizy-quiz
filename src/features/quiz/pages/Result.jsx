...
export default function Result({ score, onPlayAgain, onLogout }) {
    return (
        <Layout>
            ...
            <div className="text-white text-md md:text-2xl w-9/12 md:w-[400px] mx-5 md:mx-0">
            ...
            <div className="flex items-center justify-center mt-10 gap-5 flex-col-reverse md:flex-row">
                <button onClick={onLogout} className="bg-red-500 w-48 h-14 rounded-full text-lg text-neutral-primary">Exit!</button>
